        ...
        return function (e) {
            ...
            c.prototype.fetchImage = function (a, b, c, d) {
                ...
                return new Promise(((resolve, reject) => {
                    ...
                    if (imageUTag == pl._lastImageUTag) {
                        data.src = pl._lastImage;
                        resolve(data);
                    } else {
                        ...
                        imgBox = [pl.pictureExtent.xmin, pl.pictureExtent.ymin, pl.pictureExtent.xmax, pl.pictureExtent.ymax];
                        if (pl.isRectCross(mapBox, imgBox)) {
                            ...
                            image.onload = function () {
                                ...
                                ctx.drawImage(image, imgLeft, imgTop, imgRight - imgLeft, imgBottom - imgTop, mapLeft, mapTop, mapRight - mapLeft, mapBottom - mapTop);
                    ...
                    pl._lastImage = data.src;
                    pl._lastImageUTag = imageUTag;
                    return data;
                }).catch(error => {
